	...
	: Super(ObjectInitializer)
{
	...
	{
		static ConstructorHelpers::FObjectFinder<ULintRuleSet> DefaultMarketplaceRuleSetRef(TEXT("LintRuleSet'/Linter/GamemakinLinter/GamemakinLinterRuleSet.GamemakinLinterRuleSet'"));
