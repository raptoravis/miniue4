...
#include "LintRule_Texture_NeverStream.generated.h"

/**
 * 
 */
UCLASS(BlueprintType, Blueprintable, Abstract)
class ULintRule_Texture_NeverStream : public ULintRule
{
	GENERATED_BODY()

public:
	ULintRule_Texture_NeverStream(const FObjectInitializer& ObjectInitializer);

	UPROPERTY(EditDefaultsOnly, Category = "Settings")
	TSet<TEnumAsByte<TextureGroup>> DisableSteamInTheseGroups;
